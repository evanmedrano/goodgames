...
describe "Users::Messages::Sents" do
  describe "#index" do
    it "only allows access if the current user is viewing their own messages" do
      user = create(:user)

      get user_sent_index_path(user_id: user, as: logged_in_user(user))
    ...
    it "redirects logged in users who do not have access to the page" do
      ...
      get user_sent_index_path(user_id: user, as: logged_in_user)
    ...
    it "redirects guests who do not have access to the page" do
      ...
      get user_sent_index_path(user_id: user)
  ...
  describe "#show" do
    ...
    it "redirects logged in users who do not have access to the page" do
      ...
      get user_sent_path(user_id: user, id: 1, as: logged_in_user)
    ...
    it "redirects guests who do not have access to the page" do
      ...
      get user_sent_path(user_id: user, id: 1)
